...
class Page extends Component {
	...
	render() {
		const { start_year, end_year } = this.state;
			return(
				<div className="container-fluid bus_page">
					<div className="row background_img">
						<div className="container">
							<h3>Buses for sale in Dubai</h3>
						</div>
					</div>
					<div className="container browse_page_container">
						<div className="row">
							<div className="col-md-12">
								<p>Cras quis nulla commodo, aliguam lectus sed, blandit augue.Cras quis nulla commodo, aliguam lectus sed, blandit augue. Cras quis nulla commodo, aliguam lectus sed, blandit augue. Cras quis nulla commodo, aliguam lectus sed, blandit augue. Cras quis nulla commodo, aliguam lectus sed, blandit augue. Cras quis nulla commodo, aliguam lectus sed, blandit augue. Cras quis nulla commodo, aliguam lectus sed, blandit augue. Cras quis nulla commodo, aliguam lectus sed, blandit augue.</p>
							</div>
						</div>
						<div className="row">
							<div className="col-md-12">
